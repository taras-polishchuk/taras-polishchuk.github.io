...
function forms(formSelector, modalTimerId) {
  ...
  function showThanksModal(message) {
    const prevModlDialog = document.querySelector('.modal__dialog');
    prevModlDialog.classList.add('hide');
    ...
    setTimeout(() => {
      thanksModal.remove();
      prevModlDialog.classList.add('show');
      prevModlDialog.classList.remove('hide');
...
document.addEventListener('DOMContentLoaded', () => {
  const modalTimerId = setTimeout(() => (0,_modules_modal__WEBPACK_IMPORTED_MODULE_2__.openModal)('.modal', modalTimerId), 20000);
  ...
  (0,_modules_timer__WEBPACK_IMPORTED_MODULE_3__.default)('.timer', '2021-03-24, 10:34');
